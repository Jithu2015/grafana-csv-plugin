...
System.register(['lodash', './response_parser'], function (_export, _context) {
  var _, ResponseParse, _createClass, CsvDatasource;
  ...
  return {
    ...
    execute: function () {
      ...
      CsvDatasource = function () {
        function CsvDatasource(instanceSettings, backendSrv, timeSrv) {
